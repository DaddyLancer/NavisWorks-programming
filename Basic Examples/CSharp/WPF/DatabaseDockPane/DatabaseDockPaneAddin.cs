...
{
   [Plugin("DatabaseDockPane.DatabaseDockPaneAddin", "ADSK",
      DisplayName = "DatabaseDockPaneAddin",
      ToolTip = "Database CSharp Dock Pane Plugin")]
   public class DatabaseDockPaneAddin : AddInPlugin
   {
      public override int Execute(params string[] parameters)
      {
         ...
         //Find the plugin
         PluginRecord pr =
            Autodesk.Navisworks.Api.Application.Plugins.FindPlugin("DatabaseDockPane.DatabaseDockPanePlugin.ADSK");
